...
const roundsSeed: NewCupRound[] = [
  { stage: 0, totalClubs: 2, name: 'Final' },
  { stage: 1, totalClubs: 4, name: 'Semifinal' },
  { stage: 2, totalClubs: 8, name: 'Quarterfinal' },
  { stage: 3, totalClubs: 16, name: 'Round of 16' },
  { stage: 4, totalClubs: 32, name: 'Round of 32' },
  { stage: 5, totalClubs: 64, name: 'Round of 64' },
  { stage: 6, totalClubs: 128, name: 'Round of 128' },
];
