    ...
    <div className={cn("space-y-4", className)}>
      <div className="flex items-stretch gap-3">
        <div
          ...
          className="flex min-w-0 flex-1 flex-wrap gap-2 rounded-[20px] border border-[var(--homepage-panel-divider)] bg-white/80 p-2 shadow-[0_8px_20px_rgba(73,54,20,0.08)]"
          role="tablist"
        >
          {tabs.map((tab) => {
